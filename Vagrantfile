...
# Install PHP:
apt-get install -y php7.4 php7.4-common php7.4-mysql php7.4-mbstring php7.4-zip php7.4-gd php7.4-curl php7.4-xml php7.4-imagick php-ssh2 php7.4-bcmath php7.4-soap php7.4-intl
